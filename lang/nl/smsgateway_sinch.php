...
/**
 * Strings for component smsgateway_sinch, language 'nl'.
 *
...
$string['api_url'] = 'API Regio';
$string['api_url_help'] = 'Selecteer de Sinch API regio die overeenkomt met uw account configuratie. Dit bepaalt welke server wordt gebruikt voor het versturen van SMS berichten.';
