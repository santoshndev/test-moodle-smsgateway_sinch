...
/**
 * Strings for component smsgateway_sinch, language 'en'.
 *
...
$string['api_url'] = 'API Region';
$string['api_url_help'] = 'Select the Sinch API region that matches your account configuration. This determines which server will be used to send SMS messages.';
